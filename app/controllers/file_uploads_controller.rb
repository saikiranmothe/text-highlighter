class FileUploadsController < ApplicationController
  ...
  def show
    ...
    @key_words = KeyWord.last.keyword
    @color = KeyWord.last.color_name
    respond_to do |format|
  ...
  def create
    ...
    yomu = Yomu.new(params[:file_upload][:text_file])
    @file_upload.text_file
    @file_upload.document_text = Yomu.new(@file_upload.text_file).text
